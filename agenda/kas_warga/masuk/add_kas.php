 ...
 if(isset($_POST["simpan"])) {
     if(add_inkas($_POST) > 0) {
        ...
        Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
            ...
            window.location = '?page=i_add_masuk';
            }
        })</script>";
     }
 }
...
<div class="card card-info">
	<div class="card-header bg-info">
		<h3 class="card-title">
			<i class="fa fa-edit"></i> Tambah Data Pemasukan
        </h3>
	</div>
    <form action="" method="post" >
		<div class="card-body">
            ...
            <div class="form-group row">
				...
				<div class="col-sm-4">
                    <input type="text" class="form-control" id="masuk" name="masuk" placeholder="Masukan total pengeluaran"required>
				</div>
			</div>
		...
		<div class="card-footer">
			...
			<a href="?page=i_kas_masuk" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
<script type="text/javascript">
       ...
       masuk.addEventListener('keyup', function (e) {
         ...
         masuk.value = formasmasuk(this.value, 'Rp ');
       });
     
       /* Fungsi formasmasuk */
       function formasmasuk(angka, prefix) {
