            ...
            <div class="form-group row">
				...
				<div class="col-sm-8">
                    <select name="level"  required class="rounded">
                        <option >-- Pilih --</option>
                        <option value="Administator" <?php if($edit["level"] === "Administator") echo "selected" ?>>Administator</option>
                        <option value="Bendahara" <?php if($edit["level"] === "Bendahara") echo "selected" ?>>Bendahara</option>
                        <option value="Developer" <?php if($edit["level"] === "Developer") echo "selected" ?>>Developer</option>
                        <option value="Publik" <?php if($edit["level"] === "Publik") echo "selected" ?>>Publik</option>
                    </select>
				</div>
			</div>
