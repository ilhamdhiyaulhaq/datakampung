<?php
$conn = mysqli_connect("localhost", "root", "", "datakampung");
...
function add_warga($data)
{
    ...
    $add = "INSERT INTO tb_warga (nama_warga,tempat,ttl,jenis_kelamin,rt,nik,nkk) VALUES 
...
function add_agenda($data)
{
    ...
    // simpan syntak sql kedalam variable $query
    $add = "INSERT INTO tb_agenda (tgl_kegiatan,nama_kegiatan,keterangan) VALUES 
...
function add_rtrw($data)
{
    ...
    $query = "INSERT INTO tb_rtrw (nama,alamat,jabatan,periode_jabatan) VALUES 
...
function add_outkas($data)
{
    ...
    // query sql
    $query = "INSERT INTO kas_warga (tanggal, uraian,masuk,keluar) VALUES 
...
function registrasi($data)
{
    ...
    mysqli_query($conn, "INSERT INTO level (nama_user, username, password, level) VALUES('$nama_user','$username','$password','$level_user')");
